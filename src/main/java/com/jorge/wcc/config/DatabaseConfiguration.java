...
@Configuration
@EnableJpaRepositories("com.jorge.wcc.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
  ...
  public DataSource dataSource() {
    ...
    if (propertyResolver.getProperty("url") == null
      ...
      log.error(
          "Your database connection pool configuration is incorrect! The application cannot start. Please check your Spring profile, current profiles are: {}",
    ...
    if ("com.mysql.jdbc.jdbc2.optional.MysqlDataSource".equals(propertyResolver
      ...
      config.addDataSourceProperty("prepStmtCacheSqlLimit",
          propertyResolver.getProperty("prepStmtCacheSqlLimit", "2048"));
  ...
  public List<String> getBasePackages() {
    ...
    basePackages.add("com.jorge.wcc.domain");
    return basePackages;
  }
