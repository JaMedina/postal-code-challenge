package com.jorge.wcc.web.rest.util;
...
public class PaginationUtil {
   ...
   public static HttpHeaders generatePaginationHttpHeaders(@SuppressWarnings("rawtypes") Page page, String baseUrl, Integer offset, Integer limit) throws URISyntaxException {
